...
This project is focused on creating a loan qualifier application that has the ability to automatically assess the value of loans from a database (ie .csv file) and also save changes to the database. 
---
